...
Sou um desenvolvedor em formação apaixonado por criar soluções web e mobile. Atualmente estou focado no ecossistema Microsoft (.NET) e estudando arquitetura de software enquanto desenvolvo meu TCC.

---

### 🚀 O que estou fazendo agora
- 🎓 Cursando **Técnico em Desenvolvimento de Sistemas** na ETEC.
- 🛍️ Trabalhando no **OmniMarket**, uma plataforma de e-commerce P2P desenvolvida com **.NET MAUI** (Mobile) e **ASP.NET Core** (Backend).
- ☁️ Explorando serviços de nuvem no **Microsoft Azure** (App Services, SQL Database).
